...
# Directory values
parentdir               = "/home/jupyter/jlinford/urine/mix_tf"
analysis_dir            = parentdir + "/analysis"
bams_dir                = parentdir + "/mixture_output"
...
refdir                  = "/home/jupyter/jlinford/scripts/frag/ref"
scriptdir               = "/home/jupyter/jlinford/scripts/frag/scripts"
...
libraries_file = refdir + "/libraries_mix2.tsv"
...
rule frag_weighting_and_size_split:
    ...
    input:
        frag_bed = beds_dir + "/{library}_frag.bed",
        healthy_med = "/home/jupyter/jlinford/urine/gc_distros/healthy_med_gc_distro.rds",
